                        ...
                        if (error == null)
                        {
                            try
                            {
                                ...
                                if (msgType == "verification")
                                {
                                    ...
                                    string verifyurl = "http://hardikthaker.ga/" + Redirection_To + "?token=" + token + "&id=" + id;
                                    msg.Body = "Hi..<br/><h2><b>Wellcome to Traning and Placement Cell of <u>SK Somaiya Degree College of Arts, Science and Commerce.<u></b></h2><br/><h3><u><b>Please Click the Below Link to Activate Your account</b></u></h3><br/> url: " + verifyurl + "<br/><h4>(Please copy and paste the above URL to your browser if the link doesn't work.)</h4><br/><br/><h5><u>If you have questions or concerns, please contact us at</u></h5><br/><a>http://hardikthaker.ga/contact.aspx</a><br/><br/><h3><b><u>-Traning & Placement Team.</u></b></h3><br/><br/><hr><br/><h3><b>Please Do Not Replay To This Mail</b></h3></br><hr>";
                                }
                                else if(msgType== "forgotPass")
                                {
                                    msg.Subject = "Password Recovery Request";
                                    Redirection_To = "resetPass.aspx";
                                    string passReseturl = "http://hardikthaker.ga/" + Redirection_To + "?token=" + token + "&id=" + id;
                                    msg.Body = "Someone has requested that the password be reset for your account " + emailid + " on <a href='hardikthaker.ga'>skstpc.edu</a>.<br/><br/>If you made this request, click this below link to change your password.<br/><br/>url: " + passReseturl + "<br/><br/>If you did not make this request, click here to cancel the request.";
                                }
                                msg.IsBodyHtml = true;
