                ...
                <div style="display:inline-flex">
                    ...
                    <div style="padding-top:4px">
                        <label style='padding-top: 5px; font-size: 20px' class='mdl-radio__label'>
                            <asp:Label ID="great" runat="server" Text=""></asp:Label>. 
                            You Have Successfully Registered With Us 
                            <asp:Label ID="but" runat="server" Text=""></asp:Label>
                            Please Check Your Svv Mail Inbox and Click on Activate Your Account link.
                        </label>
                    </div>
                </div>
                <br />
