            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <label class="mdl-radio  mdl-js-radio mdl-js-ripple-effect" for="rb_status_option-2">
                        ...
                        <div runat="server" style="display: inline-flex" id="div_save">
                            <span class="mdl-spinner mdl-js-spinner is-active" style="display: none" id="spinner"></span>
                            <div style="padding: 5px 5px 8px 5px; align-self: flex-start">
                                <asp:LinkButton OnClick="btn_saveAndContinue_Click" ID="btn_saveAndContinue" CssClass="mdl-button mdl-color--accent mdl-js-button mdl-js-ripple-effect mdl-color-text--white mdl-shadow--8dp" runat="server">
                                    <span class="material-icons">check</span>
                                        Save & Next
                                    <span class="material-icons">arrow_forward</span>
                                </asp:LinkButton>
                            </div>
                            <div style="padding: 8px 5px 5px 5px; align-self: flex-end">
                                <asp:LinkButton ID="btn_save" OnClick="btn_save_Click" CssClass="mdl-button mdl-color--accent mdl-js-button mdl-js-ripple-effect mdl-color-text--white mdl-shadow--8dp" runat="server">
                                    <span class="material-icons">check</span>
                                        Save&nbsp;
                                </asp:LinkButton>
                            </div>
