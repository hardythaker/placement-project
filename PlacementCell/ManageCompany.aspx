<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="ManageCompany.aspx.cs" Inherits="PlacementCell.ManageCompany" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" src="AdminEditorTools/js/companyManager.js"></script>
</asp:Content>
    ...
    <form runat="server">
        <div class="mdl-card mdl-shadow--6dp" style="width:100%;align-items:center">
            <div class="mdl-card__title mdl-color--primary mdl-color-text--white" style="width:100%">
                <h2 class="mdl-card__title-text">Manage Company</h2>
            </div>
            <br />
                <div style="width:40%">
                    <table id="CompanyTable" class="display" width="100%">
                        <thead>
                            <tr>
                                <th>Sr no.</th>
                                <th>Company Name</th>
