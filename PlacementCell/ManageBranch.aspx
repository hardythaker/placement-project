<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="ManageBranch.aspx.cs" Inherits="PlacementCell.ManageBranch" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" src="AdminEditorTools/js/branchManager.js"></script>
</asp:Content>
    ...
    <form runat="server">
        <div class="mdl-card mdl-shadow--6dp" style="width:100%;align-items:center">
            <div class="mdl-card__title mdl-color--primary mdl-color-text--white" style="width:100%">
                <h2 class="mdl-card__title-text">Manage Branch</h2>
            </div>
            <br />
                <div style="width:40%">
                    <table id="BranchTable" class="display" width="100%">
                        <thead>
                            <tr>
                                <th>Sr no.</th>
                                <th>Branch Name</th>
